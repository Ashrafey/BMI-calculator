...
function calculateBmi() {
    ...
    if (isNaN(height) || isNaN(weight) || weight <= 20 || height <= 100 || totalClicks <= 0) {
        ...
        if (bmi < 18.5) {
            message = `<h4 class="me-5 fs-6 text-info fw-bolder" style="text-align: center;" style="margin-right:100px;" style="text-light;" style="padding:10px;">Underweight: Focus on gradual weight gain. Eat good and nutrious food</h4>`;
        } else if (bmi < 25) {
            message = `<h4 class="fs-6 text-success fw-bolder" style="text-align: center;" style="margin-right:150px;" style="text-light;"  style="padding:10px;"> Healthy Weight: You are at a healthy weight!   Good Job</h4>`;
        } else if (bmi < 30) {
            message = `<h4 class="text-warning fs-6" style="text-align: center;" style="margin-right:80px;" style="text-light;"  style="padding:10px;">Overweight: Adopt healthy eating habits, consider guidance from expert.</h4>`;
        } else {
            message = `<h4 class="fs-6 text-danger" style="text-align: center;" style="margin-right:150px;" style="text-light;"  style="padding:10px;">Obese: Focus on gradual weight loss.Eat a healthy and balanced diet .</h4>`;
        }
